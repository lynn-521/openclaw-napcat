...
> **⚠️ DISCLAIMER**: This plugin is open-source personal development for learning and research purposes. Any actions taken using this plugin (such as sending messages, group management operations, etc.) are the sole responsibility of the user. The developer is not liable for any direct or indirect damages caused by using this plugin.
...
- **Rate Limiting** -- Three-tier rate limits: minute/hour/day, prevents message flooding
- **Admin Permission Guard** -- High-risk operations require admin authorization; non-admins are blocked
